    ...
    try {
        ...
        if (tid == 'movie' || tid == 'tv') {
            url += '/' + tid + '/recommend?apiKey=' + apiKey
                + '&tags=&sort=T&refresh=0&selected_categories=' + JSON.stringify(extend)
